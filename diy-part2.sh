...
sed -i "/minidlna_status.htm/a\echo "DISTRIB_DESCRIPTION='|Build_Date@blacknesswing'" >> /etc/openwrt_release" package/lean/default-settings/files/zzz-default-settings
