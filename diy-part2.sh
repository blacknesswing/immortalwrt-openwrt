...
sed -i "/minidlna_status.htm/a\sed -i '/DISTRIB_DESCRIPTION/d' /etc/openwrt_release" package/lean/default-settings/files/zzz-default-settings
sed -i "/minidlna_status.htm/a\echo "DISTRIB_DESCRIPTION='|Build_Date@blacknesswing'" >> /etc/openwrt_release
 /etc/openwrt_release" package/lean/default-settings/files/zzz-default-settings
